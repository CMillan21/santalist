...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function randomTarget() {
        targetX = 50 + Math.random() * 50; // 80–100
        targetY = 50 + Math.random() * 50;
    }

    function animate() {
        // Movimiento progresivo (lerp)
        x += (targetX - x) * 0.02;
        y += (targetY - y) * 0.02;
    ...
    // Cambia el objetivo cada cierto tiempo
    randomTarget();
                ...
                <nav class="flex items-center justify-end gap-4">
                    ...
                    @else
                        <a
                            ...
                            class="opcion"
                        >
                            Login with &nbsp;<img src="{{ asset('images/google.svg') }}" class="google_icon" width="30px">
                        </a>
